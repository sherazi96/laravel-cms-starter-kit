        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Manage Blog Articles</h3>
              <div class="card-tools">
                <a href="{{ route('blog.article.create', ['id' => $category->id]) }}" class="btn btn-primary">
                  <i class="fa fa-user mr-2"></i> Add new article
                </a>
              </div>
            </div>
            <!-- /.card-header -->
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="width: 15rem">
                      ...
                      <a href="{{ route('blog.article.delete', ['id' => $article->id]) }}"
